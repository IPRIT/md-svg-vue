<script>
  export default {
    name: 'md-picture-in-picture-alt',

    functional: true,

    // serverCacheKey: props => `md-picture-in-picture-alt:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-picture-in-picture-alt${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

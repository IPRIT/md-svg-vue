<script>
  export default {
    name: 'md-perm-scan-wifi',

    functional: true,

    // serverCacheKey: props => `md-perm-scan-wifi:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-perm-scan-wifi${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

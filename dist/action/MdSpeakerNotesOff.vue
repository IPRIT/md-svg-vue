<script>
  export default {
    name: 'md-speaker-notes-off',

    functional: true,

    // serverCacheKey: props => `md-speaker-notes-off:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-speaker-notes-off${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-important-devices',

    functional: true,

    // serverCacheKey: props => `md-important-devices:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-important-devices${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

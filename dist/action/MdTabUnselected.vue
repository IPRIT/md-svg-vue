<script>
  export default {
    name: 'md-tab-unselected',

    functional: true,

    // serverCacheKey: props => `md-tab-unselected:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-tab-unselected${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

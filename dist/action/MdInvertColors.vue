<script>
  export default {
    name: 'md-invert-colors',

    serverCacheKey: props => {
      return `md-invert-colors:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render (h) {
      const data = {
        staticClass: 'icon md-icon md-invert-colors',

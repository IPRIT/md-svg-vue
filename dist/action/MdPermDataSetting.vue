<script>
  export default {
    name: 'md-perm-data-setting',

    functional: true,

    // serverCacheKey: props => `md-perm-data-setting:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-perm-data-setting${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

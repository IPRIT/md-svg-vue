<script>
  export default {
    name: 'md-perm-device-information',

    functional: true,

    // serverCacheKey: props => `md-perm-device-information:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-perm-device-information${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-camera-enhance',

    functional: true,

    // serverCacheKey: props => `md-camera-enhance:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-camera-enhance${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

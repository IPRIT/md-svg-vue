<script>
  export default {
    name: 'md-youtube-searched-for',

    functional: true,

    // serverCacheKey: props => `md-youtube-searched-for:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-youtube-searched-for${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

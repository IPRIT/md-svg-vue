<script>
  export default {
    name: 'md-shopping-basket',

    functional: true,

    // serverCacheKey: props => `md-shopping-basket:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-shopping-basket${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

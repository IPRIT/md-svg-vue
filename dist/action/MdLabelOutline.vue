<script>
  export default {
    name: 'md-label-outline',

    functional: true,

    // serverCacheKey: props => `md-label-outline:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-label-outline${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

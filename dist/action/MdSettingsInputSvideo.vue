<script>
  export default {
    name: 'md-settings-input-svideo',

    functional: true,

    // serverCacheKey: props => `md-settings-input-svideo:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-settings-input-svideo${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-system-update-alt',

    functional: true,

    // serverCacheKey: props => `md-system-update-alt:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-system-update-alt${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

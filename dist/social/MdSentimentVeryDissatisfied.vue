<script>
  ...
  export default {
    ...
    serverCacheKey: props => {
      return `md-sentiment-very-dissatisfied:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render () {
      const data = {
        staticClass: 'icon md-icon md-sentiment-very-dissatisfied',

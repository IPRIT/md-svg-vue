<script>
  export default {
    name: 'md-sentiment-very-dissatisfied',

    functional: true,

    // serverCacheKey: props => `md-sentiment-very-dissatisfied:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-sentiment-very-dissatisfied${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

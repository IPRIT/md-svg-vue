<script>
  export default {
    name: 'md-monochrome-photos',

    functional: true,

    // serverCacheKey: props => `md-monochrome-photos:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-monochrome-photos${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

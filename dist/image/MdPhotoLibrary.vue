<script>
  export default {
    name: 'md-photo-library',

    functional: true,

    // serverCacheKey: props => `md-photo-library:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-photo-library${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

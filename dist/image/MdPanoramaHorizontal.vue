<script>
  export default {
    name: 'md-panorama-horizontal',

    functional: true,

    // serverCacheKey: props => `md-panorama-horizontal:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-panorama-horizontal${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

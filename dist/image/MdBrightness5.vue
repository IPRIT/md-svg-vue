<script>
  export default {
    name: 'md-brightness-5',

    functional: true,

    // serverCacheKey: props => `md-brightness-5:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-brightness-5${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

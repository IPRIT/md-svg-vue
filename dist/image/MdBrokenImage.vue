<script>
  export default {
    name: 'md-broken-image',

    functional: true,

    // serverCacheKey: props => `md-broken-image:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-broken-image${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-panorama-wide-angle',

    functional: true,

    // serverCacheKey: props => `md-panorama-wide-angle:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-panorama-wide-angle${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

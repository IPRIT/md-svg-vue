<script>
  export default {
    name: 'md-brightness-3',

    functional: true,

    // serverCacheKey: props => `md-brightness-3:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-brightness-3${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

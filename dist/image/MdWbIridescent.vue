<script>
  export default {
    name: 'md-wb-iridescent',

    functional: true,

    // serverCacheKey: props => `md-wb-iridescent:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-wb-iridescent${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-nature-people',

    functional: true,

    // serverCacheKey: props => `md-nature-people:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-nature-people${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

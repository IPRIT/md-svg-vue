<script>
  export default {
    name: 'md-center-focus-weak',

    functional: true,

    // serverCacheKey: props => `md-center-focus-weak:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-center-focus-weak${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

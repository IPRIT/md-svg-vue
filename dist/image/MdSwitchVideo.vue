<script>
  export default {
    name: 'md-switch-video',

    functional: true,

    // serverCacheKey: props => `md-switch-video:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-switch-video${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  ...
  export default {
    ...
    serverCacheKey: props => {
      return `md-photo-size-select-actual:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render () {
      const data = {
        staticClass: 'icon md-icon md-photo-size-select-actual',

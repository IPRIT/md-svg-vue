<script>
  export default {
    name: 'md-photo-size-select-small',

    functional: true,

    // serverCacheKey: props => `md-photo-size-select-small:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-photo-size-select-small${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

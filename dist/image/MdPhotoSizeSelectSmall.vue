<script>
  export default {
    ...
    serverCacheKey: props => {
      return `md-photo-size-select-small:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render (h) {
      const data = {
        staticClass: 'icon md-icon md-photo-size-select-small',

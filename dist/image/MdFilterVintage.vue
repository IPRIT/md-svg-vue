<script>
  export default {
    name: 'md-filter-vintage',

    functional: true,

    // serverCacheKey: props => `md-filter-vintage:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-filter-vintage${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

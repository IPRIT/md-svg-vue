<script>
  export default {
    name: 'md-filter-b-and-w',

    functional: true,

    // serverCacheKey: props => `md-filter-b-and-w:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-filter-b-and-w${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

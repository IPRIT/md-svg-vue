<script>
  export default {
    name: 'md-panorama-fish-eye',

    functional: true,

    // serverCacheKey: props => `md-panorama-fish-eye:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-panorama-fish-eye${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

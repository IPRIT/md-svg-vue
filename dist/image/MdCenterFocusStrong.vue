<script>
  export default {
    name: 'md-center-focus-strong',

    serverCacheKey: props => {
      return `md-center-focus-strong:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render (h) {
      const data = {
        staticClass: 'icon md-icon md-center-focus-strong',

<script>
  export default {
    name: 'md-crop-original',

    functional: true,

    // serverCacheKey: props => `md-crop-original:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-crop-original${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-restaurant-menu',

    functional: true,

    // serverCacheKey: props => `md-restaurant-menu:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-restaurant-menu${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

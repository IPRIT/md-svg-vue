<script>
  export default {
    name: 'md-edit-location',

    functional: true,

    // serverCacheKey: props => `md-edit-location:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-edit-location${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-directions-railway',

    functional: true,

    // serverCacheKey: props => `md-directions-railway:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-directions-railway${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

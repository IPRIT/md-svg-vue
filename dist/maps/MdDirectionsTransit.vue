<script>
  export default {
    name: 'md-directions-transit',

    functional: true,

    // serverCacheKey: props => `md-directions-transit:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-directions-transit${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

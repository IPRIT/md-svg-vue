<script>
  export default {
    name: 'md-directions-subway',

    functional: true,

    // serverCacheKey: props => `md-directions-subway:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-directions-subway${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

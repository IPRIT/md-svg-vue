<script>
  export default {
    name: 'md-screen-share',

    functional: true,

    // serverCacheKey: props => `md-screen-share:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-screen-share${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

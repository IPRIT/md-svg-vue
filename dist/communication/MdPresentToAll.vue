<script>
  export default {
    name: 'md-present-to-all',

    functional: true,

    // serverCacheKey: props => `md-present-to-all:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-present-to-all${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

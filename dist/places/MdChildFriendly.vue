<script>
  export default {
    name: 'md-child-friendly',

    functional: true,

    // serverCacheKey: props => `md-child-friendly:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-child-friendly${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-beach-access',

    functional: true,

    // serverCacheKey: props => `md-beach-access:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-beach-access${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

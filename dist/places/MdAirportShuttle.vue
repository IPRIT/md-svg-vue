<script>
  export default {
    name: 'md-airport-shuttle',

    functional: true,

    // serverCacheKey: props => `md-airport-shuttle:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-airport-shuttle${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-fitness-center',

    functional: true,

    // serverCacheKey: props => `md-fitness-center:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-fitness-center${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

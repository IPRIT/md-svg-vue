<script>
  export default {
    name: 'md-border-vertical',

    functional: true,

    // serverCacheKey: props => `md-border-vertical:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-border-vertical${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

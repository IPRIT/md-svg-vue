<script>
  export default {
    name: 'md-border-outer',

    functional: true,

    // serverCacheKey: props => `md-border-outer:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-border-outer${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

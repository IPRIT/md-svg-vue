<script>
  export default {
    name: 'md-pie-chart-outlined',

    functional: true,

    // serverCacheKey: props => `md-pie-chart-outlined:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-pie-chart-outlined${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

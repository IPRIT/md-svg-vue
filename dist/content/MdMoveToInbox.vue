<script>
  export default {
    name: 'md-move-to-inbox',

    functional: true,

    // serverCacheKey: props => `md-move-to-inbox:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-move-to-inbox${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-keyboard-hide',

    functional: true,

    // serverCacheKey: props => `md-keyboard-hide:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-keyboard-hide${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

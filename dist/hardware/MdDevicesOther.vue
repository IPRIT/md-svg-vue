<script>
  export default {
    name: 'md-devices-other',

    functional: true,

    // serverCacheKey: props => `md-devices-other:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-devices-other${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

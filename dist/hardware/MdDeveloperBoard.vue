<script>
  export default {
    name: 'md-developer-board',

    functional: true,

    // serverCacheKey: props => `md-developer-board:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-developer-board${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

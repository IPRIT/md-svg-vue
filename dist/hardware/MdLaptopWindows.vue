<script>
  export default {
    name: 'md-laptop-windows',

    functional: true,

    // serverCacheKey: props => `md-laptop-windows:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-laptop-windows${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

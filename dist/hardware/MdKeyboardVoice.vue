<script>
  export default {
    name: 'md-keyboard-voice',

    functional: true,

    // serverCacheKey: props => `md-keyboard-voice:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-keyboard-voice${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

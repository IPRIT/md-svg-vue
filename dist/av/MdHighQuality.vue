<script>
  export default {
    name: 'md-high-quality',

    functional: true,

    // serverCacheKey: props => `md-high-quality:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-high-quality${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

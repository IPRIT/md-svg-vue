<script>
  export default {
    name: 'md-recent-actors',

    functional: true,

    // serverCacheKey: props => `md-recent-actors:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-recent-actors${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

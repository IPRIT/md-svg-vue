<script>
  export default {
    name: 'md-videocam-off',

    functional: true,

    // serverCacheKey: props => `md-videocam-off:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-videocam-off${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

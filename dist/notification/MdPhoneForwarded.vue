<script>
  export default {
    name: 'md-phone-forwarded',

    functional: true,

    // serverCacheKey: props => `md-phone-forwarded:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-phone-forwarded${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-personal-video',

    functional: true,

    // serverCacheKey: props => `md-personal-video:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-personal-video${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

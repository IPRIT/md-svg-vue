<script>
  export default {
    name: 'md-phone-paused',

    functional: true,

    // serverCacheKey: props => `md-phone-paused:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-phone-paused${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

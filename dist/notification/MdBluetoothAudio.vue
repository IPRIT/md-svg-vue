<script>
  export default {
    name: 'md-bluetooth-audio',

    functional: true,

    // serverCacheKey: props => `md-bluetooth-audio:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-bluetooth-audio${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-airline-seat-flat',

    functional: true,

    // serverCacheKey: props => `md-airline-seat-flat:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-airline-seat-flat${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-phone-bluetooth-speaker',

    serverCacheKey: props => {
      return `md-phone-bluetooth-speaker:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render (h) {
      const data = {
        staticClass: 'icon md-icon md-phone-bluetooth-speaker',

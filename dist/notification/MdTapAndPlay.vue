<script>
  export default {
    name: 'md-tap-and-play',

    functional: true,

    // serverCacheKey: props => `md-tap-and-play:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-tap-and-play${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

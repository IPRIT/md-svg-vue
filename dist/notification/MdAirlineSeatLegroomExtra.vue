<script>
  export default {
    ...
    serverCacheKey: props => {
      return `md-airline-seat-legroom-extra:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render (h) {
      const data = {
        staticClass: 'icon md-icon md-airline-seat-legroom-extra',

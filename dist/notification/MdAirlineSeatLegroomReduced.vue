<script>
  export default {
    name: 'md-airline-seat-legroom-reduced',

    serverCacheKey: props => {
      return `md-airline-seat-legroom-reduced:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render (h) {
      const data = {
        staticClass: 'icon md-icon md-airline-seat-legroom-reduced',

<script>
  export default {
    name: 'md-ondemand-video',

    functional: true,

    // serverCacheKey: props => `md-ondemand-video:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-ondemand-video${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

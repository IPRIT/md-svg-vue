<script>
  ...
  export default {
    ...
    serverCacheKey: props => {
      return `md-airline-seat-recline-extra:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render () {
      const data = {
        staticClass: 'icon md-icon md-airline-seat-recline-extra',

<script>
  ...
  export default {
    name: 'md-do-not-disturb-off',

    serverCacheKey: props => {
      return `md-do-not-disturb-off:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render () {
      const data = {
        staticClass: 'icon md-icon md-do-not-disturb-off',

<script>
  export default {
    name: 'md-developer-mode',

    functional: true,

    // serverCacheKey: props => `md-developer-mode:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-developer-mode${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-location-searching',

    functional: true,

    // serverCacheKey: props => `md-location-searching:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-location-searching${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

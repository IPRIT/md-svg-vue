<script>
  export default {
    name: 'md-screen-lock-rotation',

    functional: true,

    // serverCacheKey: props => `md-screen-lock-rotation:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-screen-lock-rotation${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

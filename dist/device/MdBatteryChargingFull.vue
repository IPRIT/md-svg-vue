<script>
  export default {
    name: 'md-battery-charging-full',

    functional: true,

    // serverCacheKey: props => `md-battery-charging-full:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-battery-charging-full${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

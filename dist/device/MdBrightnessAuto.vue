<script>
  export default {
    name: 'md-brightness-auto',

    functional: true,

    // serverCacheKey: props => `md-brightness-auto:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-brightness-auto${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

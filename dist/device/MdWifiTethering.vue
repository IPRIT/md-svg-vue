<script>
  export default {
    name: 'md-wifi-tethering',

    functional: true,

    // serverCacheKey: props => `md-wifi-tethering:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-wifi-tethering${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

<script>
  export default {
    name: 'md-bluetooth-disabled',

    functional: true,

    // serverCacheKey: props => `md-bluetooth-disabled:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-bluetooth-disabled${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

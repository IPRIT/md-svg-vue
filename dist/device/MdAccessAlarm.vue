<script>
  export default {
    name: 'md-access-alarm',

    functional: true,

    // serverCacheKey: props => `md-access-alarm:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-access-alarm${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

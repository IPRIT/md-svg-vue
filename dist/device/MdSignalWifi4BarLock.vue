<script>
  ...
  export default {
    name: 'md-signal-wifi-4-bar-lock',

    serverCacheKey: props => {
      return `md-signal-wifi-4-bar-lock:${props.color || 'default'}:${props.width}:${props.height}:${props.className || 'icon'}`;
    },
    ...
    render () {
      const data = {
        staticClass: 'icon md-icon md-signal-wifi-4-bar-lock',

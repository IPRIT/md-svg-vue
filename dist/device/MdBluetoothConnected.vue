<script>
  export default {
    name: 'md-bluetooth-connected',

    functional: true,

    // serverCacheKey: props => `md-bluetooth-connected:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-bluetooth-connected${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

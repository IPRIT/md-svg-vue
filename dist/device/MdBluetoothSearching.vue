<script>
  export default {
    name: 'md-bluetooth-searching',

    functional: true,

    // serverCacheKey: props => `md-bluetooth-searching:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-bluetooth-searching${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

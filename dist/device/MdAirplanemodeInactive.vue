<script>
  export default {
    name: 'md-airplanemode-inactive',

    functional: true,

    // serverCacheKey: props => `md-airplanemode-inactive:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-airplanemode-inactive${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,

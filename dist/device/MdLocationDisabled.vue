<script>
  export default {
    name: 'md-location-disabled',

    functional: true,

    // serverCacheKey: props => `md-location-disabled:${props.width}:${props.height}:${props.className || 'icon'}`,
    ...
    render (h, renderContext) {
      ...
      return h('svg', {
        staticClass: `icon md-icon md-location-disabled${staticClass ? ' ' + staticClass : ''}`,
        'class': className,
        attrs: {
          width: width,
          height: height,
